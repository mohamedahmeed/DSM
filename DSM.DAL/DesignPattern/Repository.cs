...
namespace DSM.DAL
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public DSMDBContext _db;
        private readonly IUnitOfWork<DSMDBContext> _uow;
        ...
        public Repository(IUnitOfWork<DSMDBContext> unitOfWork, IConfiguration configuration)
        {
           // UserId = httpContext.UserId();

          //  CurrentLanguage = httpContext.HttpContext.LanguageId();
            _uow = unitOfWork;
            _db = _uow.DSMDBContext;
